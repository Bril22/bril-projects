...
export function Footer({
    ...
    return (
        <div className='bg-black/25 p-4'>
            <div className='flex flex-col justify-start items-center border border-font-primary rounded-lg p-12 md:p-24 text-center'>
                <div className='container mx-auto flex md:flex-row flex-col gap-8 w-full justify-between items-center'>
                    ...
                    >
                        <ul className="grid grid-cols-2 md:items-center md:justify-center md:flex gap-6">
                            {menu?.map((item, i) => {
                                return (
