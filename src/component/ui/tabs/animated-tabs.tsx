...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-row gap-4 items-center justify-start relative overflow-auto max-w-full w-full h-fit scrollbar-hidden",
          containerClassName
        )}
      >
        {propTabs.map((tab, idx) => (
          ...
          >
            ...
            <span className="relative block text-white w-44">
              {tab.title}
            </span>
          </button>
        ))}
